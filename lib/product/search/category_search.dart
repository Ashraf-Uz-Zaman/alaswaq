              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(widget.productList.items.length.toString()+' Results Found',style: TextStyle( fontFamily: 'montserrat', fontSize: 12),),
                  ),
//                  Row(
//                    children: [
//                      GestureDetector(
                                ...
                                child: FlatButton(
                                    onPressed: () async {
                                      if (!HomePageState.isLogin) {
                                        ...
                                        if(widget.productList.items[index].typeId == "configurable") {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => ConfirabaleProducts(widget.productList, index,
                                                widget.productList.items[index].sku, productPrice[index], "configurable")),
