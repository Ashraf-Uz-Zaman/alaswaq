...
//                                    overflow: TextOverflow.ellipsis,
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              isPressedSubCategory = !isPressedSubCategory;
                            });
                          },
                        ): Container(),
                        index == 1 ?
                        IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              isPressedSubCategory1 = !isPressedSubCategory1;
                            });
                          },
                        ): Container(),
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              isPressedSubCategory2 = !isPressedSubCategory2;
                            });
                          },
                        ): Container(),
                        index == 3 ?
                        IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              isPressedSubCategory3 = !isPressedSubCategory3;
                            });
                          },
                        ): Container(),
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              isPressedSubCategory4 = !isPressedSubCategory4;
                            });
                          },
                        ): Container(),
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              isPressedSubCategory5 = !isPressedSubCategory5;
                            });
                          },
                        ): Container(),
                        index == 6 ?
                        IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              isPressedSubCategory6 = !isPressedSubCategory6;
                            });
                          },
                        ): Container(),
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              isPressedSubCategory7 = !isPressedSubCategory7;
                            });
                          },
                        ): Container(),
                        index == 8 ?
                        IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              isPressedSubCategory8 = !isPressedSubCategory8;
                            });
                          },
                        ): Container(),
                        index == 9 ?
                        IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              isPressedSubCategory9 = !isPressedSubCategory9;
                            });
                          },
                        ): Container(),
                        index == 10 ?
                        IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              isPressedSubCategory10 = !isPressedSubCategory10;
                            });
                          },
                        ): Container(),
                      ],
                    ...
                    ListView.builder(
                        ...
                        shrinkWrap: true,
                        scrollDirection: Axis.vertical,
                        itemCount: categoryList.childrenData[firstIndex].childrenData[index].childrenData.length, itemBuilder: (context, index2) {
                      return Builder(
                        builder: (BuildContext context) {
                          return
                            Container(
                                  ...
                                  Row(
                                    children: [
                                      SizedBox(
                                        ...
                                        child: GestureDetector(
                                          child:Text( "   " +
                                            categoryList.childrenData[firstIndex].childrenData[index].childrenData[index2].name,
//                                    overflow: TextOverflow.ellipsis,
                                          style: TextStyle( fontFamily: 'montserrat',
                                              fontSize: 12,
                                              ...
                                              MaterialPageRoute(
                                                  builder: (context) =>
                                                      ShowSearchProductPage(
                                                          categoryId: categoryList.childrenData[firstIndex].childrenData[index].childrenData[index2].id, name: "All"))
                                        ),
                                      ),
                                      ),
