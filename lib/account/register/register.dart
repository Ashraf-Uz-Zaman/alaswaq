...
//                                                                saveUserData(userDataFromServer);
  ...
  String validatePassword(String value) {
    String patttern = r'(^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z]).{8,15}$)';
    RegExp regExp = new RegExp(patttern);
    if (value.length == 0) {
...
//          ));
  ...
  Future resgisterUserApi (String email, String firstName, String lstName,String password) async {
