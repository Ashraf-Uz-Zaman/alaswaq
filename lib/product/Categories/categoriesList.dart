...
//    print(id);
//    var url ='https://aswaqrak.ae/rest/V1/products?searchCriteria[filter_groups][0][filters][0][field]=category_id& searchCriteria[filter_groups][0][filters][0][value]=$id';
//    print(url);
//    try {
