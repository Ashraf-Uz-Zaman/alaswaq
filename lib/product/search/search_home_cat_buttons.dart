...
class ShowHomeButtonCatPage extends StatefulWidget {
String fromPage;
  int categoryId;
String name;

  ShowHomeButtonCatPage(this.fromPage, this.categoryId,{this.name} );

  @override
  ShowHomeButtonCatPageState createState() => ShowHomeButtonCatPageState();
}

class ShowHomeButtonCatPageState extends State<ShowHomeButtonCatPage> {
                  ...
                  Row(
                    children: [
                      GestureDetector(
                        onTap: () async {
                          _key.currentState
                              .showBottomSheet((context) => CatButtonFilters("From Cat Button", widget.categoryId.toString(), catName));
                          },
                        child: Image.asset(
    ...
    ApiRepository.loadhotSellingProduct(catId).then((userDataFromServer) async {
      if (userDataFromServer != null) {
        setState(() {
          ...
          productqty = new List<int>.generate(productList.items.length, (i) => i );
          productPrice =
