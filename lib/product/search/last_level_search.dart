...
class LastLevelSearchProductPage extends StatefulWidget {
  ...
  LastLevelSearchProductPage({this.productList, this.sku,this.categoryId,this.name});

  @override
  LastLevelSearchProductPageState createState() => LastLevelSearchProductPageState();
}

class LastLevelSearchProductPageState extends State<LastLevelSearchProductPage> {
                  ...
                  Row(
                    children: [
                      GestureDetector(
                        onTap: () {
                          _key.currentState
                              .showBottomSheet((context) => Filters("From First Level Search", widget.categoryId.toString(),allOptionPrice,allOptionPrice));
                        },
                        child: Image.asset(
