...
//              )
  ...
  Future removeCartUserItem(int itemId) async {
    ...
    var url = 'https://aswaqrak.ae/rest/V1/carts/mine/items/$itemId';
  ...
  Future removeCartGuestItem(int itemId) async {
    ...
    String headerText = "Bearer " + token2;
    var url =
        'https://aswaqrak.ae/rest/V1/guest-carts/$token2/items/$itemId';
    print(url);
    var response = await http.delete(url, headers: {
      "Content-Type": "application/json",
      HttpHeaders.authorizationHeader: headerText
...
//      await totalCartUser();
  ...
  Future getUserShippingCost(String userKey) async {
    ...
    var response = await http.post(
        'https://aswaqrak.ae/rest/V1/carts/mine/estimate-shipping-methods',
  ...
  Future totalCartGuest() async {
    ...
    print(token2);
    String headerText = "Bearer " + token2;
    print('https://aswaqrak.ae/rest/V1/guest-carts/$token2/totals');
  ...
  Future getGuestCartAddressId(String guestKey) async {
    var response = await http.get(
        'https://aswaqrak.ae/rest/V1/guest-carts/$guestKey',
        headers: {
          "Content-Type": "application/json"
        });
    final responseJson = json.decode(response.body);
  ...
  Future guestShippingCost(int addressId, String guestKey) async {
    ...
    var body = json.encode(data);
var url =   'https://aswaqrak.ae/rest/V1/guest-carts/$guestKey/estimate-shipping-methods' ;
print(url);
    var response = await http.post(
        'https://aswaqrak.ae/rest/V1/guest-carts/$guestKey/estimate-shipping-methods',
  ...
  Future applyGuestDiscount() async {
    ...
    String headerText = "Bearer " + token2;
    var code = discountController.text;
    print('https://aswaqrak.ae/rest/V1/guest-carts/$token2/coupons/$code');
    final response = await http.put(
      'https://aswaqrak.ae/rest/V1/guest-carts/$token2/coupons/$code',
      headers: {
        "Content-Type": "application/json",
        HttpHeaders.authorizationHeader: headerText
      },
