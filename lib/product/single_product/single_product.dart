...
//      finalSku =  widget.sku;
      ...
      setState(() {
       priceVal =  widget.price
            .toString();
        productqty = new List<int>.generate(widget.productList.items.length, (i) => i + 1);
        productPrice =
  ...
  final List<Widget> imageSliders = imgList
    ...
    child: Container(
      ...
      child: ClipRRect(
          ...
          child: Stack(
            children: <Widget>[
              Image.network(item, width: 300.0),
//              Positioned(
//                bottom: 0.0,
//                left: 0.0,
//                right: 0.0,
...
<<<<<<< HEAD
                      image: DecorationImage(
                        image: NetworkImage(
                            "http://alaswaq1.bgm.me/pub/media/catalog/product/cache/9e61d75d633e5fc1a695bad0376a2475" +
                                widget
                                    .productList
                                    .items[widget.index]
                              ...
                              children: <Widget>[
                                ClipRRect(
                                  ...
                                  CachedNetworkImage(
                                    ...
                                    imageUrl:  "http://alaswaq1.bgm.me/pub/media/catalog/product/cache/9e61d75d633e5fc1a695bad0376a2475"+widget.productList.items[widget.index].mediaGalleryEntries[0].file,
                                    placeholder: (context, url) => Center(
                                        child: CircularProgressIndicator()
                                    ),
                                    errorWidget: (context, url, error) => Image(
                                      fit: BoxFit.contain,
                                      image: NetworkImage("http://alaswaq1.bgm.me/pub/media/catalog/product/cache/9e61d75d633e5fc1a695bad0376a2475"+widget.productList.items[widget.index].mediaGalleryEntries[0].file ),
                                    ),
...
//                          ,
                        ...
                        SizedBox(width: 70, height: 35,
                          child: FlatButton(
                            ...
                            onPressed: () {
                              setState(() {
                                if(widget.productList.items[widget.index].mediaGalleryEntries.length >= 2 ){
                                  galleryIndex = 1;
                                } else {
                              ...
                              children: <Widget>[
                                ClipRRect(
                                  ...
                                  CachedNetworkImage(
                                    ...
                                    imageUrl: widget.productList.items[widget.index].mediaGalleryEntries.length >= 2 ? "http://alaswaq1.bgm.me/pub/media/catalog/product/cache/9e61d75d633e5fc1a695bad0376a2475"+widget.productList.items[widget.index].mediaGalleryEntries[1].file : "http://gulfwest.bgm.me/pub/media/catalog/product"+widget.productList.items[widget.index].mediaGalleryEntries[0].file,
                                    placeholder: (context, url) => Center(
                                        child: CircularProgressIndicator()
                                    ),
                                    errorWidget: (context, url, error) => Image(
...
//                          ,
                        ...
                        SizedBox(width: 70, height: 35,
                          child:  FlatButton(
                            ...
                            onPressed: () {
                              setState(() {
                                if(widget.productList.items[widget.index].mediaGalleryEntries.length >= 3 ){
                                  galleryIndex = 2;
                                } else {
                              ...
                              children: <Widget>[
                                ClipRRect(
                                  ...
                                  CachedNetworkImage(
                                    ...
                                    imageUrl: widget.productList.items[widget.index].mediaGalleryEntries.length >= 3 ? "http://alaswaq1.bgm.me/pub/media/catalog/product/cache/9e61d75d633e5fc1a695bad0376a2475"+widget.productList.items[widget.index].mediaGalleryEntries[2].file : "http://gulfwest.bgm.me/pub/media/catalog/product"+widget.productList.items[widget.index].mediaGalleryEntries[0].file,
                                    placeholder: (context, url) => Center(
                                        child: CircularProgressIndicator()
                                    ),
                                    errorWidget: (context, url, error) => Image(
...
=======
              widget.productList.items[widget.index].mediaGalleryEntries.length  >  1 ?  Container(
          padding: EdgeInsets.only(bottom: 10.0, top: 10, left: 10, right: 10),
          height: 60,
          child: Row(
            ...
            children: [
              GestureDetector(
                  onTap: (){
                    _controller.animateTo(100.0 * widget.productList.items[widget.index].mediaGalleryEntries.length - 1, duration: Duration(seconds: 5), curve: Curves.fastOutSlowIn);
                    _controller.animateTo(0, duration: Duration(seconds: 5), curve: Curves.fastOutSlowIn);
                  },
                  child: Image.asset("assets/images/icons/arrow_back.png",width: 20,)
              ),
              SizedBox(
              ...
              Container(
                width: widget.productList.items[widget.index].mediaGalleryEntries.length < 3 ? widget.productList.items[widget.index].mediaGalleryEntries.length * 105.0 : 300.0,
                child:  ListView.builder(
//                            shrinkWrap: true,
                  controller: _controller,
                  itemCount: widget.productList.items[widget.index].mediaGalleryEntries.length,
                                    ...
                                    children: <Widget>[
                                      ClipRRect(
                                        ...
                                        CachedNetworkImage(
                                          ...
                                          imageUrl:  "https://aswaqrak.ae/pub/media/catalog/product/cache/9e61d75d633e5fc1a695bad0376a2475"+widget.productList.items[widget.index].mediaGalleryEntries[index].file,
                                          placeholder: (context, url) => Center(
                                            child:  SpinKitPulse(
                                              color: Colors.red,
                                              size: 50.0,
...
//                                          errorWidget: (context, url, error) => Image(
//                                            fit: BoxFit.contain,
//                                            image: NetworkImage("https://aswaqrak.ae/pub/media/catalog/product/cache/9e61d75d633e5fc1a695bad0376a2475"+widget.productList.items[widget.index].mediaGalleryEntries[0].file ),
//                                          ),
...
//                                  fit: BoxFit.contain,
//
//                                  imageUrl:  "https://aswaqrak.ae/pub/media/catalog/product/cache/9e61d75d633e5fc1a695bad0376a2475"+widget.productList.items[widget.index].mediaGalleryEntries[0].file,
//                                  placeholder: (context, url) => Center(
//                                      child:  SpinKitPulse(
//                                              color: Colors.red,
//                                              size: 50.0,
...
//                                  fit: BoxFit.contain,
//
//                                  imageUrl: widget.productList.items[widget.index].mediaGalleryEntries.length >= 2 ? "https://aswaqrak.ae/pub/media/catalog/product/cache/9e61d75d633e5fc1a695bad0376a2475"+widget.productList.items[widget.index].mediaGalleryEntries[1].file : "https://aswaqrak.ae/pub/media/catalog/product"+widget.productList.items[widget.index].mediaGalleryEntries[0].file,
//                                  placeholder: (context, url) => Center(
//                                      child:  SpinKitPulse(
//                                              color: Colors.red,
//                                              size: 50.0,
...
//                                  fit: BoxFit.contain,
//
//                                  imageUrl: widget.productList.items[widget.index].mediaGalleryEntries.length >= 3 ? "https://aswaqrak.ae/pub/media/catalog/product/cache/9e61d75d633e5fc1a695bad0376a2475"+widget.productList.items[widget.index].mediaGalleryEntries[2].file : "https://aswaqrak.ae/pub/media/catalog/product"+widget.productList.items[widget.index].mediaGalleryEntries[0].file,
//                                  placeholder: (context, url) => Center(
//                                      child:  SpinKitPulse(
//                                              color: Colors.red,
//                                              size: 50.0,
...
<<<<<<< HEAD
                            Text(
                              widget.productList.items[widget.index].name.toUpperCase(),
...
=======
                        ...
                        width: MediaQuery.of(context).size.width - 30,
                           child:  Text(
                              widget.productList.items[widget.index].name,
                              maxLines: 2,
                        ...
                        child: Row (
                          children: [
                            Text(
                              ...
                              style: TextStyle(color: Colors.black, fontSize: 15,  fontWeight: FontWeight.w400, fontFamily: 'montserrat'),
                            ),
                            Text( availability == 1 ?
                              'In Stock' : 'Not in Stock',

                              style: TextStyle(color: Colors.black, fontSize: 15,  fontWeight: FontWeight.bold, fontFamily: 'montserrat'),
                            ),
                          ],
                        )
...
//                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Container(
                            ...
                            child: Padding(
                              padding:
                                  const EdgeInsets.only(bottom: 0.0, top: 10, left:1, right: 1),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(
                                  ...
                                  isOptionSelected ? Container() : Text(
                                      "Select options !",
                                    style:TextStyle( fontFamily: 'montserrat',
                                        fontSize: 14,
                                        color: Colors.red,
...
//                                                finalSku = HomePageState.allProductSku[index].toString();
                                                ...
                                                selectedOptionValue = optionValueLis[index];
                                                priceVal = allOptionPrice[index].toString();
                                              });
                                              _onSelected(index);
                                            },
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Text(
                                                    "AED: " + allOptionPrice[index].toString(),
//                                                "AED ",
                                                  style: TextStyle( fontFamily: 'montserrat',
...
//                      width: 100,
                      ...
                      child: ListView.builder(
                        ...
                        shrinkWrap: true,
                        scrollDirection: Axis.horizontal,
                        itemCount: widget.productList.items.length > 10 ? 10 : widget.productList.items.length,
...
//                                            Products("1","1",2.0, "1","1"),
                                      Products(widget.productList, index,
                                          widget.productList.items[0].sku),
=======
                                      widget.productList.items[index].typeId == "configurable" ? Products(widget.productList, index,
                                          widget.productList.items[index].sku, productPrice[index], "configurable") :  Products(widget.productList, index,
...
//                                          ),
                                      ...
                                      Row(
                                        children: [
                                          widget.productList.items[index].typeId == "configurable" ?    Text(
                                            'AED ' +
<<<<<<< HEAD
...
//    for (var i = 0;
//    i < widget.productList.items[widget.index].extensionAttributes.configurableProductOptions.length;
//    i++) {

      setState(() {
        attributeId = widget.productList.items[widget.index].extensionAttributes.configurableProductOptions[0].attributeId ;
        oprionLabel =  widget.productList.items[widget.index].extensionAttributes.configurableProductOptions[0].label;
        for(int i=0; i< widget.productList.items[widget.index].extensionAttributes.configurableProductOptions[0].values.length; i++){
          optionValueLis.add(widget.productList.items[widget.index].extensionAttributes.configurableProductOptions[0].values[i].valueIndex.toString());
        }
...
//    }
  ...
  Future getPortionValues(String attributeId) async {
    var url = 'https://aswaqrak.ae/rest/V1/products/attributes/$attributeId';
    try {
      print(url);
...
//        });
        ...
        getProductPrice(widget.productList.items[widget.index].sku);
      } else
      {
...
//    print(allOptionPrice.length);
  ...
  Future getAttributeValues() async {
    ...
    for (var i = 0;
    i < widget.productList.items[widget.index].customAttributes.length;
    i++) {
      if (widget.productList.items[widget.index].customAttributes[i]
          .attributeCode ==
          "custom_label") {
        setState(() {
          shortDesc =
              widget.productList.items[widget.index].customAttributes[i].value;
        });
      }
      if (widget.productList.items[widget.index].customAttributes[i]
          .attributeCode ==
...
//    await getUserCartList();
  ...
  Future addCartGuestConfProduct(String sku,int qty, String optionValue) async {
...
print("inside call price");
    for(int i = 0; i<widget.productList.items.length; i++ ){
      if(widget.productList.items[i].typeId == "configurable") {
        ...
        getProductPriceYouMayLike(widget.productList.items[i].sku, i);
      }
    }
  }
  ...
  final sku = widget.sku;
    print('https://aswaqrak.ae/rest/V1/stockStatuses/$sku');
    final response = await http.get(
      'https://aswaqrak.ae/rest/V1/stockStatuses/$sku',
      headers: {
        "Content-Type": "application/json"
      },
    );
