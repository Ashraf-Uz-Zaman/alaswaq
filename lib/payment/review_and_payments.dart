...
//  List<String >street = new List<String>();
  ...
  TextEditingController addressController = new TextEditingController( text:street0);
  TextEditingController cityController = new TextEditingController(text : "Ras Al-Khaimah");
  TextEditingController stateController = new TextEditingController(text: street1);
  TextEditingController zipController = new TextEditingController(text: postalcode);
  TextEditingController phoneController = new TextEditingController(text: phoneNum);
  TextEditingController countryController = new TextEditingController(text: "United Arab Emirates");
              ...
              children: [
                ...
                Row(
                  children: [
                    Row(
                      children: [
                        Radio(activeColor: Colors.black,
                          value: 0,
                  ...
                  child: Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text( street0,
                          style: new TextStyle(fontSize: 14.0, color: Colors.grey, fontWeight: FontWeight.w400,fontFamily: 'montserrat'),
                        ) ,
                        Text( street1,
                          style: new TextStyle(fontSize: 14.0, color: Colors.grey, fontWeight: FontWeight.w400,fontFamily: 'montserrat'),
                        ),
                           ...
                           child: Row (
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    phoneNum != "" ? Icon(Icons.phone_in_talk) : Text(""),
                                    Text(
                                      phoneNum,
                                      style: TextStyle( fontFamily: 'montserrat', fontSize: 15),
                                    ),
                                ...
                                FlatButton(
                                  ...
                                  child: Text('CHANGE ADDRESS',
                                      style: TextStyle(
                                        color:  HexColor("302d98"), fontSize: 12,fontFamily: 'montserrat', fontWeight: FontWeight.w600,
                      ...
                      children: [
                        Padding(
                          ...
                          GestureDetector(
                            ...
                            child: Text('Order Summary',style: TextStyle( fontFamily: 'montserrat', fontSize: 15),),
                          ),
                        ),
                                                  ...
                                                  children: <Widget>[
                                                    RichText(
                                                      ...
                                                      text: TextSpan(
                                                        text: 'AED ',
                                                        style:
                                                          TextStyle( fontFamily: 'montserrat', fontSize: 16,color: Colors.black87,),
...
//                                        )
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  'AED' + ShoppingCart.grandTotal.toString(),
                                  style:  TextStyle( fontFamily: 'montserrat',
                    ...
                    child: Row(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Text('   Ship to',style: TextStyle( fontFamily: 'montserrat', fontSize: 15),),
                        ),
...
//        "region_code": userreg_model.addresses[0].region.regionCode,
    ...
    final response = await http.post(
      'https://aswaqrak.ae/rest/V1/carts/mine/shipping-information',
...
//        "region_code":  userreg_model.addresses[0].region.regionCode,
    ...
    var body = json.encode(data);
    final response = await http.post(
      'https://aswaqrak.ae/rest/V1/carts/mine/payment-information',
      headers: {"Content-Type": "application/json", HttpHeaders.authorizationHeader: headerText},
      body: body,
    );
    final responseJson = json.decode(response.body);
  ...
  Future<bool> mergeCarttoUserCart() async {
    ...
    final response1 = await http.put(
      'https://aswaqrak.ae/rest/V1/guest-carts/$guestKey2',
      headers: {"Content-Type": "application/json", HttpHeaders.authorizationHeader: headerText},
      body: body1,
    );
