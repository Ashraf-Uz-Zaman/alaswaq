...
class PopularProducts extends StatefulWidget {
  ...
  String productType;
  String imageUrl ;
  PopularProducts(this.popularproductList, this.index, this.sku, this.price, this.productType, this.imageUrl );
...
//                      color: HexColor("F9F9F9F9"),s
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              widget.popularproductList.items[widget.index].name,
                              maxLines: 2,
...
//                                            Products("1","1",2.0, "1","1"),
                                      PopularProducts(widget.popularproductList, index,
                                          widget.popularproductList.items[index].sku,widget.popularproductList.items[index].price,"normal", widget.imageUrl),
                                    ),
                                  );
                                },
                                child: Card(
...
//                                                    );
  ...
  Future getAttributeValues() async {
    for (var i = 0;
    i < widget.popularproductList.items[widget.index].customAttributes.length;
    i++) {
      if (widget.popularproductList.items[widget.index].customAttributes[i]
        ...
        setState(() {
          shortDesc =
              widget.popularproductList.items[widget.index].customAttributes[i].value;
        });
      }
      if (widget.popularproductList.items[widget.index].customAttributes[i]
          .attributeCode ==
