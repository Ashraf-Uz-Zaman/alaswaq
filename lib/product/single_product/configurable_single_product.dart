...
class ConfirabaleProducts extends StatefulWidget {
  ProductListModel productList;
  int index;
  String sku;
  double price;
  String productType;
  ConfirabaleProducts(this.productList, this.index, this.sku, this.price, this.productType );

  ConfirabaleProductsState createState() => ConfirabaleProductsState();
}

class ConfirabaleProductsState extends State<ConfirabaleProducts> {
...
//      finalSku =  widget.sku;
      ...
      print("sdfevrvrtr");
      productqty = new List<int>.generate(widget.productList.items.length, (i) => 1);
    });
  }
...
//                                                finalSku = HomePageState.allProductSku[index].toString();
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Text(
                                                  "AED: " +  ShowSearchProductPageState.allOptionPrice[index].toString(),
//                                                "AED ",
                                                  style: TextStyle( fontFamily: 'montserrat',
...
//                                            Products("1","1",2.0, "1","1"),
                                      ConfirabaleProducts(widget.productList, index,
  ...
  Future getPortionValues(String attributeId) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(responseJson);
//           var optionLis1 = responseJson["options"][0]["label"]  ;
//        optionLis =  responseJson["options"][1]["label"];
        setState(() {
