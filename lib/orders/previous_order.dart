                                ...
                                children: <Widget>[
                                  Card(
                                    ...
                                    child:CachedNetworkImage(
                                      height: 80,
                                      fit: BoxFit.contain,
                                      imageUrl: previousimageUrls[index],
                                            ...
                                            children: <Widget>[
                                              RichText(
                                                ...
                                                text: TextSpan(
                                                  ...
                                                  children: <TextSpan>[
                                                    TextSpan(
                                                        text: previousprice[index].toString(),
                                                        style: TextStyle( fontFamily: 'montserrat',
                                                            fontWeight: FontWeight.bold,
                                                            fontSize: 16)),
                                                  ],
...
//          await getInvoiceNumber(orderList.items[i].items[j].orderId, token2);
          previousinvoiceId.add(previousorderList.items[i].items[j].orderId.toString());
...
//    var response = await http.post('https://aswaqrak.ae/rest/V1/order/$orderNumber./invoice',
//        headers: {"Content-Type": "application/json", HttpHeaders.authorizationHeader: headerText},
//        body: body
//    );
